...
Before joining Arizona, I worked in Taiwan on satellite image super-resolution and large-scale image analysis, and received my M.S. in Electronics and Computer Engineering from the [National Taiwan University of Science and Technology](https://ece.ntust.edu.tw/index.php?Lang=en). My master's work was completed under [Prof. Chung-Hsiang Lin](https://www.et.ntust.edu.tw/et/faculty.php?user=chlin&lang=en) in the **MERGE Lab**.
